...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState(['digaor@gmail.com']);
  ...
  function addNewEmailToInvite(event: FormEvent<HTMLFormElement>) {
    ...
    const checkExistsGuests = emailsToInvite.includes(email);

    if (checkExistsGuests) {
      return console.log('Esta pessoa já foi adicionado à lista de convidados.');
    }
  ...
  function removeEmailFromInvite(emailToRemove: string) {
    const newEmailsToInviteList = emailsToInvite.filter((email) => email !== emailToRemove);
